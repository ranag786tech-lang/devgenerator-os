...
function ImageFileTool({ file, setFile, setError, setLoading, setOutput, action, dimensions, setDimensions }: ControlProps & { action: 'compress' | 'resize'; dimensions?: { width: number; height: number }; setDimensions?: (value: { width: number; height: number }) => void }) {
